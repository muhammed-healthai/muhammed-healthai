...
| <div align="center">📝 [**Patient Data Centre**](https://github.com/muhammed-healthai/patient-data-centre) </div>| A ward clinical record — patient timelines, cumulative results, a synthetic imaging viewer, and an ED→ward journey view — backed by Supabase with authenticated, RLS-enforced access and real-time updates from ED Tracker. |
| <div align="center">💊 [**De Novo Drug Design**](https://www.github.com/muhammed-healthai/de-novo-drug-design) </div>| Generative RNN trained to invent over 600 novel, chemically valid drug candidates. |
